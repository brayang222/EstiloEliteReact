    ...
    <section id="hero">
      <div className="hero-container container">
        <div className="hero-left">
          ...
          <p>"El Estilo Élite para hombres es más que moda, es una declaración de poder y elegancia. Asume el control de tu vida, forjando una imagen que refleje tu presencia y autoestima."</p>
